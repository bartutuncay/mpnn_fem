## Cantilever supports - Warped mesh - Non-uniform load
...
s = (z - zmin) / zspan
theta = total_twist_rad * s  # linear ramp
...
os.makedirs('datasets/cantilever/warped/non_uniform',exist_ok=True)
torch.save(
    {
        "nodes": model.nodes,
        "stiffness": model.K,
    ...
    f"datasets/cantilever/warped/non_uniform/sim_{idx}.pt",
)