...
alias = 'equivariant_cantilever_regular_uniform'
ckpt_path = Path(f"../../../scratch/btuncay/gnn/ablation_models/1_simple_dataset/{alias}/weights_5200.pt")
...
with torch.no_grad():
    for data in train_loader:
        ...
        if c >= 100:
            break
# Save to a new file
save_path = f"../../../scratch/btuncay/gnn/ablation_models/1_simple_dataset/{alias}/2_0328_preds_{alias}.pt"
