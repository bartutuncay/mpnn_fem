## Cantilever supports - Warped mesh - Uniform load
...
os.makedirs('datasets/cantilever/warped/uniform',exist_ok=True)
torch.save(
    {
        "nodes": model.nodes,
        "stiffness": model.K,
    ...
    f"datasets/cantilever/warped/uniform/sim_{idx}.pt",
)
