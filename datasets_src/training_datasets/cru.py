## Cantilever supports - Regular mesh - Uniform load
...
os.makedirs('datasets/cantilever/regular/uniform',exist_ok=True)
torch.save(
    {
        "nodes": model.nodes,
        "stiffness": model.K,
    ...
    f"datasets/cantilever/regular/uniform/sim_{idx}.pt",
)
