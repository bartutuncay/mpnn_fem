## CAntilever supports - WArped shape - UNiform load
...
load_type = np.random.choice(['bending','shear','torsion','axial','point'])
...
torch.save(
    ...
    f"../../../scratch/btuncay/gnn/ablation_datasets/cantilever/warped/uniform/sim_{idx}.pt",
)
