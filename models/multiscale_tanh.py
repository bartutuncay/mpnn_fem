...
alias = "multiscale_tanh_cantilever_warped_non_uniform"
print(alias)
os.makedirs(f"../../../scratch/btuncay/gnn/ablation_models/2_geometry/{alias}",exist_ok=True)
...
train_loader = make_loader('../../../scratch/btuncay/gnn/ablation_datasets/cantilever/warped/non_uniform/train', batch_size=1, shuffle=True, num_workers=4)
...
for epoch in range(1, EPOCHS + 1):
    ...
    if epoch == 1 or epoch % 100 == 0:
        torch.save(model.state_dict(), f"../../../scratch/btuncay/gnn/ablation_models/2_geometry/{alias}/weights_{epoch}.pt")

print("Best val:", best_val)

pd.DataFrame(loss_records).to_csv(f"../../../scratch/btuncay/gnn/ablation_models/2_geometry/{alias}/losses.csv", index=False)
