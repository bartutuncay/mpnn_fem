## Variable BC supports - Regular mesh - Non-uniform load
...
os.makedirs('datasets/var_bc/regular/non_uniform',exist_ok=True)
torch.save(
    {
        "nodes": model.nodes,
        "stiffness": model.K,
    ...
    f"datasets/var_bc/regular/non_uniform/sim_{idx}.pt",
)
