# Evaluate Model with tanh Activation Functions and Positional Encoding, 64 Feature Dimensions
...
model = GEN_Multiscale(in_channels=10,edge_in=3,layers=4,layers_coarse=12,latent_dim=64,out_channels=3).to(device)
