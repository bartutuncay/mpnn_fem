# Dataloader for models using spherical coordinates
...
def collate_pt_dicts(samples: Sequence[Dict[str, Any]]) -> DataBatch:
    ...
    edge_index, edge_attr = _collate_edges(
        samples, edge_key="edge_index", attr_key="edge_attr_sph", num_nodes=num_nodes_list)
    ...
    # Spherical edge attributes: coarse,broadcasting,aggregation
    edge_index_coarse, edge_attr_coarse = _collate_edges(
        samples, edge_key="edge_index_coarse", attr_key="edge_attr_coarse_sph", num_nodes=num_nodes_list)
    edge_index_diff, edge_attr_diff = _collate_edges(
        samples, edge_key="edge_index_diff", attr_key="edge_attr_diff_sph", num_nodes=num_nodes_list)
    edge_index_aggr, edge_attr_aggr = _collate_edges(
        samples, edge_key="edge_index_aggr", attr_key="edge_attr_aggr_sph", num_nodes=num_nodes_list)
